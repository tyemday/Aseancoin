...
C++ compilers are memory-hungry, so it is recommended to have at least 1 GB of memory available when compiling Asncoin. With less memory, compilation may take much longer due to swapfile thrashing.
...
Compile Asncoin for Ubuntu (64-bit)
-----------------------------
...
Compile Asncoin for Windows (64-bit)
------------------------------
...
To create a statically linked Asncoin which only depends on default MacOS dylibs, the following steps are taken:
...
-----
 ...
 multichaind ASN@asncoin.com:9976 -daemon
